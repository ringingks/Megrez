...
SERVER_NAME='Megrez.EurekaServer'
# jar名称
JAR_NAME='Megrez_EurekaServer.jar'
cd `dirname $0`
BIN_DIR=`pwd`
cd ..
DEPLOY_DIR=`pwd`
...
STDOUT_FILE=$LOGS_DIR/meridian.EurekaServer.stdout.log
...
#CONFIG_FILES=" -Dlogging.path=$LOGS_DIR -Dlogging.config=$CONF_DIR/log4j.properties -Dspring.config.location=$CONF_DIR/application.properties "
